...
interface WomensDetailClientProps {
  slug: string;
}

export default function WomensDetailClient({ slug }: WomensDetailClientProps) {
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xl text-white/80">$74.99</p>
              </div>
